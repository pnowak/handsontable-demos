...
import { hotOptions } from '../src/hotchart';
...
describe('HotChart', function() {
  ...
  it( 'is a class', () => {
	...
	/*it( 'expects hotChart.hot to be instanceof Handsontable', () => {
    const hot = new Handsontable('testContainer');

		expect( hotChart.hot ).toBe(instanceof hot);
	} );*/
  ...
  describe('have a chart -> AmChart', function() {
    ...
    describe('have a chart -> HighChart', function() {
